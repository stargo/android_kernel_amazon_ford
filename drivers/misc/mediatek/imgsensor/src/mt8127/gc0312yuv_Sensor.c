...
kal_uint16 GC0312_Read_Shutter(void)
{
	...
	kal_uint32 shutter,step,shutter_iso;
...
void GC0312NightMode(kal_bool bEnable)
{
	if (bEnable) {
		...
		if (GC0312_MPEG4_encode_mode == KAL_TRUE) {  
			...
			GC0312_write_cmos_sensor(0x35, 0x08);  /*2.25x level 1*/
			GC0312_write_cmos_sensor(0x36, 0x0d);   /*3.5x   level 2*/
			GC0312_write_cmos_sensor(0x37, 0x10);   /*6x   level 3*/
...
void GC0312_Sensor_Init(void)
{
	...
	GC0312_write_cmos_sensor(0x78, 0x58);
	GC0312_write_cmos_sensor(0x79, 0xa9);
	...
	GC0312_write_cmos_sensor(0x94, 0x08);   
	...
	GC0312_write_cmos_sensor(0xa4, 0x20);  /*30 travis 20140929*/
	GC0312_write_cmos_sensor(0xa5, 0x3c);  /*30 travis 20140929*/
	...
	GC0312_write_cmos_sensor(0xfe, 0x00);
	GC0312_write_cmos_sensor(0xbf, 0x06);
	GC0312_write_cmos_sensor(0xc0, 0x14);
	GC0312_write_cmos_sensor(0xc1, 0x2b);
	GC0312_write_cmos_sensor(0xc2, 0x46);
	GC0312_write_cmos_sensor(0xc3, 0x5b);
	GC0312_write_cmos_sensor(0xc4, 0x6e);
	GC0312_write_cmos_sensor(0xc5, 0x7b);
	GC0312_write_cmos_sensor(0xc6, 0x93);
	GC0312_write_cmos_sensor(0xc7, 0xa5);
	GC0312_write_cmos_sensor(0xc8, 0xb7);
	GC0312_write_cmos_sensor(0xc9, 0xc6);
	...
	GC0312_write_cmos_sensor(0xfe, 0x00);
	GC0312_write_cmos_sensor(0x5f, 0x12);
	GC0312_write_cmos_sensor(0x60, 0x22);
	GC0312_write_cmos_sensor(0x61, 0x31);
	GC0312_write_cmos_sensor(0x62, 0x3d);
	GC0312_write_cmos_sensor(0x63, 0x49);
	GC0312_write_cmos_sensor(0x64, 0x54);
	GC0312_write_cmos_sensor(0x65, 0x5e);
	GC0312_write_cmos_sensor(0x66, 0x71);
	GC0312_write_cmos_sensor(0x67, 0x82);
	GC0312_write_cmos_sensor(0x68, 0x92);
	GC0312_write_cmos_sensor(0x69, 0xa0);
	GC0312_write_cmos_sensor(0x6a, 0xae);
	GC0312_write_cmos_sensor(0x6b, 0xba);
	GC0312_write_cmos_sensor(0x6c, 0xc6);
	GC0312_write_cmos_sensor(0x6d, 0xd8);
	GC0312_write_cmos_sensor(0x6e, 0xe4);
	GC0312_write_cmos_sensor(0x6f, 0xef);

	GC0312_write_cmos_sensor(0xb1, 0xb0);
	GC0312_write_cmos_sensor(0xb2, 0xd0);
	GC0312_write_cmos_sensor(0xb3, 0x80); 
	GC0312_write_cmos_sensor(0xb4, 0x90); 
	...
	GC0312_write_cmos_sensor(0xd2, 0x2a);   
	GC0312_write_cmos_sensor(0xd3, 0x42);    /*40*/
	GC0312_write_cmos_sensor(0xd5, 0x00);    /*40*/
	...
	GC0312_write_cmos_sensor(0x13, 0x39);  /*3c*/
	...
	GC0312_write_cmos_sensor(0x59, 0x02);
	...
	GC0312_write_cmos_sensor(0x6a, 0x03);  /*25 outdoor thd*/
	...
	GC0312_write_cmos_sensor(0x77, 0x45);
	...
	GC0312_write_cmos_sensor(0xfe, 0x01);
	GC0312_write_cmos_sensor(0x90, 0xcb);
	GC0312_write_cmos_sensor(0x91, 0xbe);
	GC0312_write_cmos_sensor(0x92, 0xf0);
	GC0312_write_cmos_sensor(0x93, 0xcc);
	GC0312_write_cmos_sensor(0x95, 0x1a);
	GC0312_write_cmos_sensor(0x96, 0xf0);
	GC0312_write_cmos_sensor(0x97, 0x43);
	GC0312_write_cmos_sensor(0x98, 0x1a);
	GC0312_write_cmos_sensor(0x9a, 0x43);
	GC0312_write_cmos_sensor(0x9b, 0x1a);
	...
	GC0312_write_cmos_sensor(0xa4, 0xb6);
	GC0312_write_cmos_sensor(0xa5, 0xa2);
	GC0312_write_cmos_sensor(0xa6, 0xb6);
	GC0312_write_cmos_sensor(0xa7, 0x95);
	GC0312_write_cmos_sensor(0xa9, 0xbc);
	GC0312_write_cmos_sensor(0xaa, 0x95);
	GC0312_write_cmos_sensor(0xab, 0xab);
	GC0312_write_cmos_sensor(0xac, 0x8d);
	GC0312_write_cmos_sensor(0xae, 0xc8);
	GC0312_write_cmos_sensor(0xaf, 0xab);
	...
	GC0312_write_cmos_sensor(0xfe, 0x01);
	GC0312_write_cmos_sensor(0xd0, 0x40);  
	GC0312_write_cmos_sensor(0xd1, 0xfc);  
	GC0312_write_cmos_sensor(0xd2, 0x06);
	GC0312_write_cmos_sensor(0xd3, 0xea);
	GC0312_write_cmos_sensor(0xd4, 0x42);
	GC0312_write_cmos_sensor(0xd5, 0xec);

	GC0312_write_cmos_sensor(0xd6, 0x42);   
	GC0312_write_cmos_sensor(0xd7, 0x04);   
	GC0312_write_cmos_sensor(0xd8, 0x09);   
	GC0312_write_cmos_sensor(0xd9, 0x00);  
	GC0312_write_cmos_sensor(0xda, 0x40);   
	GC0312_write_cmos_sensor(0xdb, 0xec);
	...
	GC0312_write_cmos_sensor(0xc4, 0x20);    
	GC0312_write_cmos_sensor(0xc5, 0x1a);
	GC0312_write_cmos_sensor(0xc6, 0x1a);
	...
	GC0312_write_cmos_sensor(0x2e, 0x04);   /*10step level 4 17*/
	GC0312_write_cmos_sensor(0x2f, 0x09);
	GC0312_write_cmos_sensor(0x30, 0xa0);   /*14step  level 5 12fps*/
	GC0312_write_cmos_sensor(0x31, 0x0a);
	GC0312_write_cmos_sensor(0x32, 0xd4);   /*14 step  level 6 10fps*/
	GC0312_write_cmos_sensor(0x33, 0x0c);
	GC0312_write_cmos_sensor(0x34, 0x08);   /* level 7*/
	GC0312_write_cmos_sensor(0x35, 0x08);  /*2.25x level 1*/
	GC0312_write_cmos_sensor(0x36, 0x0d);   /*3.5x   level 2*/
	GC0312_write_cmos_sensor(0x37, 0x10);   /*6x   level 3*/
...
BOOL GC0312_set_param_banding(UINT16 para)
{
	...
	case AE_FLICKER_MODE_50HZ:
		...
		GC0312_write_cmos_sensor(0x26, 0x9a);  /*8a   //step*/     
		GC0312_write_cmos_sensor(0x27, 0x01);                      
		GC0312_write_cmos_sensor(0x28, 0x34);  /*2step  level 1   3 30fps*/
		GC0312_write_cmos_sensor(0x29, 0x02);                      
		GC0312_write_cmos_sensor(0x2a, 0x68);   /*4step level 2  25 fps*/
		GC0312_write_cmos_sensor(0x2b, 0x04);                      
		GC0312_write_cmos_sensor(0x2c, 0xd0);   /*5step level 3  12.5*/
		GC0312_write_cmos_sensor(0x2d, 0x06);                      
		GC0312_write_cmos_sensor(0x2e, 0x04);   /*10step level 4 10*/
		GC0312_write_cmos_sensor(0x2f, 0x09);                      
		GC0312_write_cmos_sensor(0x30, 0xa0);   /*14step  level 5 6.25fps*/
		GC0312_write_cmos_sensor(0x31, 0x0a);                      
		GC0312_write_cmos_sensor(0x32, 0xd4);   /*14 step  level 6 5.5fps*/
		GC0312_write_cmos_sensor(0x33, 0x0c);                      
		GC0312_write_cmos_sensor(0x34, 0x08);   /* level 7   5*/       
		GC0312_write_cmos_sensor(0x35, 0x08);  /*2.25x level 1*/   
		GC0312_write_cmos_sensor(0x36, 0x0d);   /*3.5x   level 2*/ 
		GC0312_write_cmos_sensor(0x37, 0x10);   /*6x   level 3*/   
		GC0312_write_cmos_sensor(0x38, 0x14);   /*  level 4*/      
	...
	case AE_FLICKER_MODE_60HZ:
		...
		GC0312_write_cmos_sensor(0x2f, 0x09);
		GC0312_write_cmos_sensor(0x30, 0x93);   /*14step  level 5 12fps*/
		GC0312_write_cmos_sensor(0x31, 0x0a);
		GC0312_write_cmos_sensor(0x32, 0x95);   /*14 step  level 6 10fps*/
		GC0312_write_cmos_sensor(0x33, 0x0b);
		GC0312_write_cmos_sensor(0x34, 0x97);   /* level 7*/
		GC0312_write_cmos_sensor(0x35, 0x08);  /*2.25x level 1*/
		GC0312_write_cmos_sensor(0x36, 0x0d);   /*3.5x   level 2*/
		GC0312_write_cmos_sensor(0x37, 0x10);   /*6x   level 3*/
		GC0312_write_cmos_sensor(0x38, 0x14);   /*  level 4*/
